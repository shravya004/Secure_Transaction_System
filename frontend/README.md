...
| Person 2 (tanishasenapati13) | Frontend (React dashboard, transaction UI, ledger explorer, alerts panel, SHAP), AI+ML|
| Person 3 (Ishita2005cse) | Backend + ML, DNN model, Cryptography |
